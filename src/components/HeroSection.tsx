            ...
            <section className="text-center relative z-10">
              ...
              <div className="flex justify-center">
                <Button
                  as={Link}
                  href="/directory"
                  className="cursor-pointer h-12 px-7 text-base bg-gradient-to-r from-blue-500 text-white font-semibold rounded-xl hover:from-blue-600 transition-all transform hover:scale-105"
